    ...
    <SubPageLayout className="text-text-dark">
      <div className="max-w-3xl mx-auto py-10 pb-20 space-y-12">
        ...
        <div className="space-y-3 border-b border-text-dark/10 pb-8">
          <p className="font-mono text-xs uppercase tracking-widest text-text-dark/40">
            Legal
          </p>
        ...
        <div className="space-y-10 text-sm sm:text-base font-light leading-relaxed text-text-dark/80">
          <section className="space-y-3">
            ...
            <p>
              nemo:on(이하 &quot;회사&quot;)은 이용자의 개인정보를 중요시하며,
              「개인정보 보호법」을 준수합니다. 본 방침은 회사가 운영하는
              웹사이트(<strong>nemoon.co</strong>)를 통해 수집되는 개인정보의
              처리에 관한 사항을 규정합니다.
            </p>
          </section>
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-text-dark/5">
                    <th className="text-left px-4 py-2 font-semibold border border-text-dark/10 w-1/3">
                      구분
                    </th>
                    <th className="text-left px-4 py-2 font-semibold border border-text-dark/10">
                      수집 항목
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="px-4 py-2 border border-text-dark/10 align-top">
                      필수
                    </td>
                    <td className="px-4 py-2 border border-text-dark/10">
                      이름, 전화번호, 이메일 주소, 문의 내용
                    </td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-text-dark/10 align-top">
                    ...
                    <td className="px-4 py-2 border border-text-dark/10">
                      회사명, 참고 URL, 첨부 파일(jpg·png·pdf·zip, 최대 40MB)
                    </td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-text-dark/10 align-top">
                    ...
                    <td className="px-4 py-2 border border-text-dark/10">
                      IP 주소(스팸 방지 rate limit 용도, 즉시 폐기)
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <section className="space-y-3">
            ...
            <p>
              수집된 개인정보는 상담 완료 후 <strong>1년</strong> 이내에
              파기합니다. 단, 관계 법령에 따라 일정 기간 보존이 필요한 경우 해당
              기간 동안 별도 보관합니다.
            </p>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-sm">
          ...
          <section className="space-y-3">
            ...
            <p>
              권리 행사는 아래 개인정보 보호책임자에게 이메일로 요청하시면 지체
              없이 조치하겠습니다.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="bg-text-dark/3 border border-text-dark/10 px-5 py-4 space-y-1">
              <p>
                <span className="font-semibold">책임자:</span> nemo:on 대표
              </p>
              <p>
                <span className="font-semibold">이메일:</span>{" "}
                <a
                  href="mailto:turn.nemoon@gmail.com"
          ...
          <section className="space-y-3">
            ...
            <p>
              본 방침은 법령 변경 또는 서비스 정책 변경에 따라 수정될 수
              있습니다. 변경 시 시행일 7일 전부터 웹사이트를 통해 공지합니다.
            </p>
          </section>
        </div>
        ...
        <div className="pt-8 border-t border-text-dark/10">
          <a
            href="/contact"
            className="text-xs font-mono uppercase tracking-widest text-text-dark/40 hover:text-brand transition-colors"
          >
            ← 문의 페이지로 돌아가기
          </a>
        </div>
