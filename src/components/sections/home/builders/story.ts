...
export const buildStoryTimeline = (
  ...
  if (isMobileView) {
    ...
    tl.fromTo('#story-paragraph-3', { opacity: 0, x: '15vw', y: '-10vh' }, { opacity: 1, x: '15vw', y: '-18vh', duration: step * 0.6, ease: 'power2.out' }, p3Start + step * 0.2);
  } else {
    tl.fromTo('#story-bg-white', { opacity: 1, xPercent: -100, yPercent: 0 }, { xPercent: -50, duration: step * 0.6, ease: 'power3.inOut' }, p3Start);
  ...
  if (isMobileView) {
    ...
    tl.fromTo('#story-paragraph-4', { opacity: 0, x: '15vw', y: '-18vh' }, { opacity: 1, x: '15vw', y: '-10vh', duration: step * 0.6, ease: 'power2.out' }, p4Start + step * 0.2);
  } else {
  ...
  if (isMobileView) {
    ...
    tl.fromTo('#story-paragraph-5', { opacity: 0, x: '-23vw', y: 0 }, { opacity: 1, x: '-15vw', y: 0, duration: step * 0.6, ease: 'power2.out' }, p5Start + step * 0.2);
  } else {
    tl.to('#story-bg-white', { xPercent: 50, duration: step * 0.8, ease: 'power3.inOut' }, p5Start);
