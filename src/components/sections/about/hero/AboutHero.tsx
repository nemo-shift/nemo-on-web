...
export default function AboutHero() {
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        onLeave: () => {
          ...
          const targetTrigger = ScrollTrigger.getById('about-philosophy-trigger');
          const targetScroll = targetTrigger ? targetTrigger.start : '#about-philosophy';
  ...
  }, { dependencies: [isInitialized, isMobileView, isTabletPortrait], scope: containerRef });
  ...
  return (
    ...
    >
      ...
      <h1 className="about-hero-title absolute top-[15%] font-dm text-[clamp(60px,10vw,150px)] font-bold tracking-widest uppercase text-[#0d1a1f] select-none pointer-events-none z-20">
