...
export default function AboutPromise() {
  ...
  // [Zero-Gap Sync] 마지막 섹션이므로 푸터 리빌 타이밍을 빠르게 하기 위해 가중치 배율 축소 (상수 파일 sub-interaction.ts 연동)
  const scrollMultiplier = ABOUT_SCROLL_MULTIPLIERS.PROMISE;
      ...
      <div className="w-full h-screen flex flex-col items-center justify-center relative">
        ...
        >
          ...
          <div className="relative w-full h-[280px] sm:h-[220px] tablet:h-[240px] flex justify-center">
            ...
            <div 
              ref={phase1Ref}
              className={`absolute top-0 left-1/2 -translate-x-1/2 ml-4 tablet-p:ml-36 tablet:ml-24 w-full max-w-[85vw] tablet-p:max-w-[480px] tablet:max-w-[550px] flex flex-col text-left ${ABOUT_STAGE_STYLES.promise.content.gap}`}
            >
