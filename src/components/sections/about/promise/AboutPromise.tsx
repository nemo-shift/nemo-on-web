...
export default function AboutPromise() {
  ...
  useGSAP(() => {
    ...
    // 2. 본문 콘텐츠: 서서히 페이드인하며 올라왔다가, 다음 푸터 리빌을 위해 페이드아웃
  ...
  */
  ...
  return (
    <section 
      ref={containerRef}
      id="about-promise"
      className="relative w-full h-[180vh] bg-[#f7f1e9] z-30 overflow-hidden"
    >
      ...
      <div className="w-full h-screen flex flex-col items-center justify-center relative">
        ...
        <span 
          ref={titleRef}
          className="absolute font-dm text-[clamp(44px,9vw,145px)] font-black uppercase tracking-widest text-[#0d1a1f] select-none text-center leading-none z-0"
        >
