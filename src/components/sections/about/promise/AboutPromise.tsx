      ...
      <div className="w-full h-screen flex flex-col items-center justify-center relative">
        ...
        >
          ...
          <div className="relative w-full h-[280px] sm:h-[220px] tablet:h-[240px] flex justify-center">
            ...
            <div 
              ref={phase1Ref}
              className={`absolute top-0 left-1/2 -translate-x-1/2 flex flex-col text-left ${ABOUT_STAGE_STYLES.promise.content.maxWidth} ${ABOUT_STAGE_STYLES.promise.content.paddingLeft} ${ABOUT_STAGE_STYLES.promise.content.gap}`}
            >
