...
// ─────────────────────────────────────────────
// 1.1. 카카오 인앱 뷰포트 안전 여유 (KakaoFix)
// ─────────────────────────────────────────────
// 카카오 인앱에서 주소창/툴바 높이 추정치 + 여유.
...
export const LOGO_SIZE = {
  ...
  // 히어로 전용 Y 오프셋 (음수 = 위로 이동, HERO_STILL_CONTENT_RISE에서 y:0으로 복귀)
  HERO_Y_OFFSET: -90, // PC
  HERO_Y_OFFSET_TABLET: -65, // tablet-p
  HERO_Y_OFFSET_MOBILE: -28, // mobile
};
